    ...
    if (args[0] === 'create') {
      ...
      await createRoleReaction(
        ...
        async (err, roleMessage, roles, channel) => {
          ...
          guild.role_message = roleMessage.id
          guild.channel_role_message = channel.id
          guild.roles = roles
      ...
      try {
        const {
          ...
          channel_role_message: channelRoleMessage,
        } = guild
